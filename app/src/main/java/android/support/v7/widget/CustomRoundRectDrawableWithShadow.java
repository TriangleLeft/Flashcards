 ...
 */
public class CustomRoundRectDrawableWithShadow extends Drawable {
    ...
    * */
    ...
    public CustomRoundRectDrawableWithShadow(Resources resources, int backgroundColor, float radius,
    ...
    private void drawShadow(Canvas canvas) {
        ...
        final boolean drawHorizontalEdges = false; //mCardBounds.width() - 2 * inset > 0;
