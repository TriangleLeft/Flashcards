 ...
 * Each logger name will be used as the tag for Timber if Timber has planted {@link Timber.TaggedTree}.
 * If tag contains also class package, it will be removed (same way like in {@link Timber.DebugTree}).
 * </p>
 *
