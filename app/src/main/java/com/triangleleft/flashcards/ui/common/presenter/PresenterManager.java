...
public class PresenterManager {
    ...
    private final Cache<Long, IPresenter<?, ?>> presenters;
    ...
    public <P extends IPresenter<?, ?>> P restorePresenter(long presenterId) {
        P presenter = (P) presenters.getIfPresent(presenterId);
        presenters.invalidate(presenterId);
        return presenter;
    }

    public long savePresenter(IPresenter<?, ?> presenter) {
